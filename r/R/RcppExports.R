...
write_insertion_bedgraph_cpp <- function(fragments, cell_groups, output_paths, mode_string, tile_width, normalization_method_string, chrom_sizes) {
    invisible(.Call(`_BPCells_write_insertion_bedgraph_cpp`, fragments, cell_groups, output_paths, mode_string, tile_width, normalization_method_string, chrom_sizes))
}
...
iterate_tile_matrix_cpp <- function(fragments, chr, start, end, width, chr_levels, mode) {
    .Call(`_BPCells_iterate_tile_matrix_cpp`, fragments, chr, start, end, width, chr_levels, mode)
}
...
EXPERIMENTAL_iterate_packed_sparse_column_matrix_file_uint32_t_cpp <- function(dir, buffer_size) {
    .Call(`_BPCells_EXPERIMENTAL_iterate_packed_sparse_column_matrix_file_uint32_t_cpp`, dir, buffer_size)
}

EXPERIMENTAL_write_packed_sparse_column_matrix_file_uint32_t_cpp <- function(matrix, dir, buffer_size, allow_overwrite, row_major) {
    invisible(.Call(`_BPCells_EXPERIMENTAL_write_packed_sparse_column_matrix_file_uint32_t_cpp`, matrix, dir, buffer_size, allow_overwrite, row_major))
}

EXPERIMENTAL_dims_packed_sparse_column_matrix_file_cpp <- function(dir, buffer_size) {
    .Call(`_BPCells_EXPERIMENTAL_dims_packed_sparse_column_matrix_file_cpp`, dir, buffer_size)
}
...
iterate_matrix_squaresimd_cpp <- function(matrix) {
    .Call(`_BPCells_iterate_matrix_squaresimd_cpp`, matrix)
}
...
checksum_double_cpp <- function(matrix) {
